  ...
  return (
    <>
      <motion.button
        ...
        className="btn-glow flex items-center gap-2 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 text-white px-4 py-2 rounded-xl text-sm font-semibold shadow-lg shadow-blue-500/25 animate-gradient"
      >
          ...
          <>
            ...
            >
              <motion.div
                ...
                className="w-full max-w-sm bg-neutral-900 rounded-2xl border border-white/10 shadow-2xl overflow-hidden z-50 relative"
              >
                ...
                <div className="p-4 space-y-2">
                  ...
                  <button onClick={quickCheckOut} disabled={loading} className="w-full flex items-center gap-3 p-3 rounded-xl bg-white/5 hover:bg-white/10 border border-white/5 transition-colors text-left text-neutral-200">
